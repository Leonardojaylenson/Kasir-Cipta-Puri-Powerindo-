...
<?php
function convertToGrayscale($imagePath) {
    // Load the image
    ...
    // Save the new image
    $grayscaleImagePath = 'images/grayscale_' . basename($imagePath);
    imagepng($image, $grayscaleImagePath);
...
$grayscaleImagePath = convertToGrayscale($imagePath);
...
$imageSize = getimagesize($grayscaleImagePath);
...
// Add the grayscale image to cover the full page
$pdf->Image($grayscaleImagePath, $xPosition, $yPosition, $scaledWidth, $scaledHeight, 'PNG', '', '', true, 150, '', false, false, 0, false, false, false);
