...
$sheet->setCellValue('D5', 'Harga Jual');
...
foreach ($satu as $item) {
    ...
    $sheet->setCellValue('D' . $row, number_format($item->harga_jual, 2, ',', '.'));
...
$sheet->setCellValue('F' . $row, 'Rp ' . number_format($totalAmount, 2, ',', '.'));
...
$filename = $startDateFormatted . '_to_' . $endDateFormatted . '.xlsx';
