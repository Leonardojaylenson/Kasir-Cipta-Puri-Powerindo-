...
$pdf->Cell(0, 10, 'Laporan Barang Masuk', 0, 1, 'L'); // Report title, aligned to the left
...
$html .= '<thead><tr><th>Nama Barang</th><th>Kode Barang</th><th>Quantity</th><th>Harga Beli</th><th>Total Harga</th><th>Tanggal</th></tr></thead>';
$html .= '<tbody>';
...
foreach ($satu as $item) {
    ...
    $html .= '<td>' . htmlspecialchars($item->quantity, ENT_QUOTES, 'UTF-8') . '</td>';
    $html .= '<td>' . number_format($item->harga_beli, 2, ',', '.') . '</td>';
