                                    ...
                                    ?> 
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?=base_url('home/rsbarang/'.$key ->id_barang)?>" onclick="return confirmDelete()">
                                                    <button id="showPopupButton" class="btn btn-lg btn-info btn-block hebutton"><i class="fa fa-refresh fa-spin uicon" style="font-size:16px"></i></button></a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php } ?>
...
var result = confirm("Apakah kamu yakin mau restore data pelanggan?");
