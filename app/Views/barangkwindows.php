...
<head>
    ...
    <style>
        @page {
            size: A4;
            margin: 20mm; /* Margin to accommodate content */
        }
        body {
        ...
        .page-break {
            display: none; /* Hide page break elements */
        }
    </style>
</head>
<body>
    <div class="content">
        ...
        <table id="reportTable">
            ...
            <tbody>
                ...
                <?php
                    $itemTotal = $item->jumlah * $item->harga_jual;
                ...
                <tr>
                    ...
                    <td><?= htmlspecialchars(number_format($item->jumlah, 0, ',', '.'), ENT_QUOTES, 'UTF-8') ?></td>
    ...
    window.addEventListener('load', function() {
        // Detect when print preview is shown
        window.print();
        ...
        window.onafterprint = function() {
            ...
            // Remove total row from original position
            if (totalRow && table) {
                table.parentNode.removeChild(totalRow);
                // Append the total row at the end of the content
